...
class KVStore(object):
    ...
    def __init__(self, handle):
        ...
        #========================  begin xym add this 1.4: ===============================#
        self.keys = []
        self.use_key_str = None
        #========================  end   xym add this 1.4 ===============================#
    ...
    def push(self, key, value, priority=0,compress_steps=5):
        ...
        if use_str_keys:
            check_call(_LIB.MXKVStorePushEx(
                self.handle, mx_uint(len(ckeys)), ckeys, cvals, ctypes.c_int(priority),ctypes.c_int(compress_steps)))
        else:
    ...
    #xym edit this to register the local updater 1.4
