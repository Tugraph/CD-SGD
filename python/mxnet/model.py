...
def _update_params_on_kvstore(param_arrays, grad_arrays, kvstore,compress_steps,  param_names, pull_count, num_device, updater, kvlocal):
    ...
    for index, pair in enumerate(zip(param_arrays, grad_arrays)):
        ...
        # push gradient, priority is negative index
        kvstore.push(name, grad_list, priority=-index,compress_steps=compress_steps)
        # pull back the weights
...
# xym add this 1.4: But it is not really used;
